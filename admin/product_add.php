...
<h2 class="display-6 text-center"><b>Register Product</b></h2>
  ...
  <div class="pt-3">
	...
	<button onclick="location.href='product_manage.php'" style="width:49.2%;" type="submit" class="btn btn-outline-danger" name="cancel"  >Cancel</button>
  </div>
</form>
</div>
...
<?php
	...
	$sql = "INSERT INTO product_details (name, description, price, photo, availability) VALUES ('$name', '$description', '$price', '$target_file', '$availability');";
